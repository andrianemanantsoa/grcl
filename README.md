...
export ACR_NAME=YOUR_UNIQUE_ACR_NAME # globally unique in Azure, alphanumeric only, 5-50 chars
...
You can replace `YOUR_ACR_NAME` with your `$ACR_NAME` value manually or with `sed`/`envsubst`.
